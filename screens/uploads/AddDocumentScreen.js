...
let tagList=<Text>Tag list here</Text>
  // const uploadDocument = async () => {
  //   // Check if any file is selected or not
  //   if (newDocument != null) {
  //     // If file selected then create FormData
  //     const fileToUpload = newDocument;
        ...
        <TouchableOpacity
          ...
          <Text style={styles.buttonTextStyle}>Upload File</Text>
              ...
              <View style={styles.imgContainer}>
                <Image style = {styles.image} source={{uri:newDocument}}/>
...
<TextInput style={styles.input} keyboardType='default' onChangeText={()=>{}} value=''></TextInput>
<Button title="Add tag" onPress={()=>{}}></Button>
</View>
</View>
</View>
</Card>
      {/* {newDocument ? 
      <View style= {styles.imgContainer}>
      <Image style={styles.image}         source={{uri:newDocument}}></Image>
      </View> :
       <Text>No file picked yet</Text>}
       */}
      </View>   
